...
class FaxSenderBase(object):
    ...
    def send_fax(self, destination: str, path: str, dest_name: Optional[str] = None) -> bool:
        pass
...
class SonicFax(FaxSenderBase):
    ...
    def __init__(self):
        ...
        self.notification_email = os.getenv("SONIC_NOTIFICATION_EMAIL", "support42@fighthealthinsurance.com")
    ...
    def send_fax(self, destination: str, path: str, dest_name: Optional[str] = None) -> bool:
        ...
        with requests.Session() as s:
            ...
            r = s.get("https://members.sonic.net/labs/fax", headers=headers, cookies=cookies)
            r.raise_for_status()
