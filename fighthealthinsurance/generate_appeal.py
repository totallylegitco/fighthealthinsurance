...
class AppealGenerator(object):
    ...
    async def get_fax_number(self, denial_text=None, use_external=False) -> Optional[str]:
    ...
    async def get_procedure_and_diagnosis(
        ...
        print(f"Fell through :/ could not fully populate but got {procedure}, {diagnosis}")
        return (procedure, diagnosis)
