...
from fhi_users.models import UserDomain, ExtraUserProperties, UserContactInfo, PatientUser, VerificationToken
...
class RestAuthViewsTests(TestCase):
    def setUp(self) -> None:
        ...
        self.user = User.objects.create_user(
            username=f'testuser🐼{self.domain.id}', password='testpass', email='test@example.com')
